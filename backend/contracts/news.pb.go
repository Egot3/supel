...
func (x *DeleteNewRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteNewRequest) ProtoMessage() {}

func (x *DeleteNewRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_news_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteNewRequest.ProtoReflect.Descriptor instead.
func (*DeleteNewRequest) Descriptor() ([]byte, []int) {
	return file_proto_news_proto_rawDescGZIP(), []int{11}
}

func (x *DeleteNewRequest) GetNewId() string {
	if x != nil {
		return x.NewId
	}
	return ""
...
func (x *GenerateBodyUploadURLResponse) Reset() {
	*x = GenerateBodyUploadURLResponse{}
	mi := &file_proto_news_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenerateBodyUploadURLResponse) Descriptor() ([]byte, []int) {
	return file_proto_news_proto_rawDescGZIP(), []int{13}
}
...
const file_proto_news_proto_rawDesc = "" +
	"\n" +
	"\x10proto/news.proto\x12\x04news\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\"K\n" +
...
var file_proto_news_proto_depIdxs = []int32{
	...
	12, // 7: news.NewsService.GenerateBodyUploadURL:input_type -> news.GenerateBodyUploadURLRequest
