...
CREATE UNIQUE INDEX idx_actions_full ON "actions" ("scope", "sub_scope", "verb") WHERE "sub_scope" IS NOT NULL;
CREATE UNIQUE INDEX idx_actions_subscope_null ON "actions" ("scope", "verb") WHERE "sub_scope" IS NULL;
...
CREATE INDEX idx_role_uuid_junction ON "roles_actions" ("role_uuid");
